...
CFLAGS = -Wall -Werror -align -xavx2 -funroll-all-loops -global-hoist -march=haswell -qopt-prefetch=5 -unroll-aggressive -xhaswell -no-multibyte-chars -std=gnu99 $(OPT)
