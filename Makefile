...
CFLAGS = -Wall -Werror -align -fma -fp-model strict -funroll-all-loops -global-hoist -march=haswell -qopt-prefetch=5 -unroll-aggressive -xhaswell -no-multibyte-chars -std=gnu99 $(OPT)
