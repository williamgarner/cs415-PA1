...
CFLAGS = -Wall -Werror -parallel  -align -fma -fno-math-errno -vec-threshold0 -funroll-all-loops -global-hoist -march=haswell -qopt-prefetch=5 -unroll-aggressive -xhaswell -no-multibyte-chars -std=gnu99 $(OPT)
