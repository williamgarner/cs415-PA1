...
CC = icc
OPT = -Ofast -qopt-report=1
CFLAGS = -Wall -Werror -align -fma -fno-math-errno -vec-threshold0 -funroll-all-loops -global-hoist -march=haswell -qopt-prefetch=5 -unroll-aggressive -xhaswell -no-multibyte-chars -std=gnu99 $(OPT)
